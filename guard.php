...
$blue |____/ \___/ \__||_| \_\|_| |_|\___||_____/";
    echo "
$cyan Author  : $green Dave Kgw
$lightcyan Type    : Profil Guard Facebook
$cyan Github  : http://github.com/davekgw
$red Facebook : https://www.facebook.com/ld.profile1000098661657117
$purple Version : 2.0
$darkgray Date    : $date
";
    echo " 
...
");
        ...
        echo "$red ATTENTION :$green Silahkan login melalui browser untuk menghindari Checkpoint (mis: Opera, Chrome, UC, dan lain-lain)
";
        echo "$brown Lanjutkan setelah selesai, silakan klik Enter
";
echo "$darkgray Sumber Script https://github.com/davekgw.com
";
        echo "
";
...
";
        ...
        echo "
";
        echo "$lightgreen Silahkan Cek Foto Profile Facebook anda";
        echo ".";
        sleep(1);
        echo ".";
        sleep(1);
...
";
          sleep(1.5);
        echo "$yellow Support DaveKgw , Bantu klik iklan nya Bozz ...
";
